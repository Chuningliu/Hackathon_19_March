...
# Given that the battery level of Chef's phone is X%, determine whether 
...
# (for example, Yes, YES, yes yes will be considered identical).
# Sample Input 1 
# 3
# 15
# 3
...
# Test Case 2: The battery level is 3, which is less than 15. 
# Thus, it would show a battery low notification.
# Test Case 3: The battery level is 65, which is greater than 15. 
# Thus, it would not show a battery low notification.
...
for i in range(1):
    ...
    if n1<=15:
        ...
        print("Not show battery low notification")
